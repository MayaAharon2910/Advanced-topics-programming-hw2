...
TEST(SimulationRun, FullFlowWithMockMapping) {
    ...
    // inject a mock mapping algorithm into the run factory; the skeleton
    // factory currently constructs MappingAlgorithmImpl directly.
    ...
    comp.simulations.push_back(drone_mapper::types::SimulationConfigData{"data_maps/single_voxel_x2_y4_z2.npy", 10.0 * drone_mapper::cm, drone_mapper::Position3D{}, drone_mapper::Position3D{}, 0.0 * drone_mapper::horizontal_angle[drone_mapper::deg]});
